...
SRC = src/main.c \
      ...
      src/arch/x86_64/sysv.c \
      src/arch/arm64/linux.c
...
EXAMPLES = examples/demo \
           ...
           examples/01_language/enums examples/01_language/bounds \
